...
describe("Add Data Test", () => {
  ...
  it("Check Data", () => {
    ...
    cy.get(".Toastify__toast-body").should(
      "contain",
      "Data komoditas berhasil di tambahkan"
    );
  });
});
...
describe("Edit Data Test", () => {
  ...
  it("Close Form", () => {
    ...
    cy.get(".Toastify__toast-body").should(
      "contain",
      "Data komoditas berhasil di ubah"
    );
  });
});

describe("Search Data", () => {
  it.only("Click Combo Box and select 'Lokasi'", () => {
    cy.visit("http://efishlist.herokuapp.com/");
    cy.get(
      ".searchbox_selectContainer__-0sNR > .select-react__control > .select-react__value-container"
    ).then((dropdown) => {
  ...
  it.only("Enter Value in search box 'Lokasi'", () => {
    cy.get(
      ".input_inputContainer__2NvBf > .searchbox_inputContainer__2iV57"
    ).type(`${kota}{enter}`);
  });

  it.only("Click combo box and select 'Komoditas'", () => {
    cy.get(
      ".searchbox_selectContainer__-0sNR > .select-react__control > .select-react__value-container"
    ).then((dropdown) => {
      cy.wrap(dropdown).click();
  ...
  it.only("Enter value in Search Box 'Komoditas'", () => {
    cy.get(".input_inputContainer__2NvBf > .searchbox_inputContainer__2iV57")
      .clear()
      .type(`${firstIkan}{enter}`);
  });

  it.only("Click combo box and select 'Harga'", () => {
    cy.get(
      ".searchbox_selectContainer__-0sNR > .select-react__control > .select-react__value-container"
    ).then((dropdown) => {
      cy.wrap(dropdown).click();
  ...
  it.only("Enter value in Search Box 'Harga'", () => {
    cy.get(".pricefilter_inputContainer__zvK6Q > :nth-child(1) > input")
      .clear()
      .type(`${harga}{enter}`);
    cy.get(":nth-child(2) > input").clear().type(`${harga}{enter}`);
  });

  it.only("Click combo box and select 'Ukuran'", () => {
    cy.get(
      ".searchbox_selectContainer__-0sNR > .select-react__control > .select-react__value-container"
    ).then((dropdown) => {
      cy.wrap(dropdown).click();
  ...
  it.only("Enter value in Search Box 'Ukuran", () => {
    cy.get(".pricefilter_inputContainer__zvK6Q > :nth-child(1) > input")
      .clear()
      .type(`${sizeIkan}{enter}`);
    cy.get(":nth-child(2) > input").clear().type(`${sizeIkan}{enter}`);
  });
});
