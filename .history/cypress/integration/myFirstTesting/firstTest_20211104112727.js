...
describe("Add Data Test", () => {
  ...
  it.only("Add Data", () => {
    ...
    cy.get("#hpjk6ryja9").should(
      "contain",
      "Data komoditas berhasil ditambahkan"
    );

    // cy.get(
    //   ".Home_wrapper__gja0e > .Toastify > .Toastify__toast-container > #\30 rslagcl8t"
    // ).should("be.visible");

    cy.get(
      ".Home_wrapper__gja0e > .Toastify > .Toastify__toast-container > #byvpbremfp > .Toastify__toast-body"
